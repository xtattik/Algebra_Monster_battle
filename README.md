...
- [12 pet cards](cards/pets.html) (print ~5 copies each so every student draws 2 at random)
...
- [x] Pet collection — 12 pets, [design doc](docs/design/pets.md) + [print sheet](cards/pets.html)
